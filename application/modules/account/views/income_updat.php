<table class="table table-hover" border="1" width="99%">
    ...
    <tr><td>Category Name</td><td><select name="category_name" id="category_name" class="form-control" onchange="names('category_name')" style="border-radius: 25px">
    ...
    <tr><td>Party Name</td><td><select name="party_name" id="party_name" class="form-control" onchange="names('party_name')" style="border-radius: 25px">
                <option value="<?php echo $query->party_name; ?>"><?php echo $query->party_name; ?></option>
                <?php
    ...
    <tr><td>Particular's Name</td><td><input type="text" class="text-center round_box" name="name" id="name" onkeyup="names(id)" value="<?php echo $query->name; ?>"></td></tr>
