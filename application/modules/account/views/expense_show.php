                    ...
                    <table class="table example table-hover dataTable" border="1" cellspacing="0" width="99%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Sector of Expense</th>
...
<script>
    $(document).ready(function() {
        ...
        $('.example').DataTable({
         ...
         $('#delete').click(function () {
            ...
            $.ajax({
                ...
                method: 'post',
                data: {id: id, tblname: 'tbl_expense'},
                success: function () {
                    $('#delete_nc').modal('hide');
                    window.location= base_url+"account/account/expense_show"; 
                }
            })
        });
        ...
        $('#update_c').submit(function (e) {
            ...
            if(category_name === '' ||name === ''||date === ''||amount === ''){
                ...
                $.ajax({
                    url: base_url+'account/account/expense_update',
                    method: 'post',
                    data: {category_name: category_name, id: id, name: name, date: date, unit: unit, rate: rate, amount: amount},
                    success: function () {
                        $('#update').modal('hide');
                        window.location= base_url+"account/account/expense_show";                        
                    }
    ...
    function updateIDReserver(ida){ 
        $.ajax({
                ...
                method: 'post',
                data: {id: ida, tblname: 'tbl_expense', page : 'expense_updat'},
