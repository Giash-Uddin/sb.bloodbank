    ...
    <div align="center" class="panel panel-default" style="width: 50%; margin-top: 10px; border: 1px solid black; box-shadow: 2px 2px 10px 10px #000000; opacity: 0.8">
        <div class="panel-body" >
            <div style="width: 100%; float: left; padding: 10px" >
                ...
                <center><h1>Party Name</h1></center>
                </div>
                <div style="">
...
<script>
    $(document).ready(function() {
        ...
        $('.example').DataTable({
         ...
         $('#delete').click(function () {
            ...
            $.ajax({
                ...
                method: 'post',
                data: {id: id, tblname: 'tbl_party'},
                success: function () {
                    $('#delete_nc').modal('hide');
                    window.location= base_url+"account/account/party_show"; 
                }
            })
        });
        ...
        $('#update_c').submit(function (e) {
            ...
            if(name === ''){
                ...
                $.ajax({
                    url: base_url+'account/account/party_update',
                    method: 'post',
    ...
    function updateIDReserver(ida){ 
        $.ajax({
                ...
                method: 'post',
                data: {id: ida, tblname: 'tbl_party', page : 'party_updat'},
