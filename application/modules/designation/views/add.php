        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="add_designation_form" id="add_designation_form">
                            <!--<form name="registration_form">-->
                            <div class="form-group row">
                                <label for="designation" class="col-md-4 col-form-label text-md-right">Designation</label>
                                <div class="col-md-6">
                                    <input id="designation" type="text" class="form-control" name="designation" value="" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="short_form" class="col-md-4 col-form-label text-md-right">Short Form</label>
                                <div class="col-md-6">
                                    <input id="short_form" type="text" class="form-control" name="short_form" value="" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <a class="btn btn-primary" onclick="add_designation()">Save</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function add_designation() {
        if (isValid()) {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>' + "designation/designation/save",
                type: 'post',
                data: {designation: designation, short_form: short_form, status: status},
                success: function(data) {
                    toastr.success('Designation added successfully', 'Success', {timeOut: 3000});
                    $.ajax({
                ...
                error: function() {
                    toastr.error('Designation is not added', 'Failed', {timeOut: 3000});
                    $('#container').text('An error occurred');
                }
            });
        }
